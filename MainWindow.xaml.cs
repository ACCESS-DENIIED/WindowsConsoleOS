    ...
    public partial class MainWindow : Window
    {
        ...
        private async void ChangeAudioDeviceToSelected(AudioDevice selectedDevice)
        {
            ...
            try
            {
                ...
                Dispatcher.Invoke(() =>
                {
                    // Ensure both texts are visible but CompletedText starts fully transparent
                    LoadingText.Visibility = Visibility.Visible;
                    CompletedText.Visibility = Visibility.Visible; // Make it visible but transparent
                    CompletedText.Opacity = 0; // Start fully transparent
                ...
                // After operation, hide LoadingText and prepare CompletedText
                Dispatcher.Invoke(() =>
                {
                ...
                // Fade in CompletedText (simplified step to ensure visibility)
                ...
                // Wait a moment to ensure user sees the completed state
                await Task.Delay(TimeSpan.FromSeconds(2));

                // Reset UI for next use outside of Dispatcher.Invoke to avoid blocking UI thread
                Dispatcher.Invoke(() =>
                {
